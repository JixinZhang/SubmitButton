...
typedef NS_ENUM(NSUInteger, SubmitButtonStatus) {
    SubmitButtonStatusStart = 0,    //动画开始，此时可发送网络请求，并调用- (void)loadingProgressAnimationWithProgress:(CGFloat)progress方法给动画的progress赋值。

    SubmitButtonStatusEnd = 1       //动画结束
};
